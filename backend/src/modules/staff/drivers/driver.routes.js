...
const canRead   = perm.permAny(['drivers.read',   'dashboard.view']);
const canCreate = perm.permAny(['drivers.create',  'dashboard.view']);
const canUpdate = perm.permAny(['drivers.update',  'drivers.activate', 'drivers.deactivate', 'drivers.reset_password', 'dashboard.view']);
const canDelete = perm.permAny(['drivers.delete',  'dashboard.view']);
...
router.get('/:id/tours',              canRead,   ctrl.tours.bind(ctrl));
