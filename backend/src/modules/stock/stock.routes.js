...
router.use('/operations',          require('./stock_operations/stock_operation.routes'));
router.use('/moves',               require('./stock_moves/stock_move.routes'));
router.use('/lots',                require('./stock_lots/stock_lot.routes'));
