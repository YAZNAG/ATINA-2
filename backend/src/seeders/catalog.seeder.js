...
const LOCATION_NODE_PERMISSIONS = [
  ...
  { name: 'Supprimer les provinces', code: 'provinces.delete', module: 'location', description: '' },
  ...
  { name: 'Supprimer les villes', code: 'cities.delete', module: 'location', description: '' },
  ...
  { name: 'Modifier les types node', code: 'node_types.update', module: 'node', description: '' },
  { name: 'Supprimer les types node', code: 'node_types.delete', module: 'node', description: '' },
