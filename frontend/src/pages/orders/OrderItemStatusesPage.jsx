            ...
            {isEdit ? (
              ...
              <>
                <input name="code" className={`${inp} font-mono`} value={form.code}
                  ...
                  placeholder="active" />
                <p className="text-[11px] text-gray-400 mt-1">Minuscules, tirets bas — ex: active, cancelled, substituted</p>
              </>
            )}
          </Fld>
          {form.color && (
        ...
        <div className="px-6 pt-5 pb-4">
          <div className="flex items-start justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">Statut individuel de chaque article dans une commande — active, cancelled, substituted, out_of_stock</p>
            </div>
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            {!search && (
              <button onClick={handleSeed} disabled={seeding} className="px-5 py-2.5 border border-gray-200 text-gray-600 text-sm font-semibold rounded-xl hover:bg-gray-50 disabled:opacity-50">
                <Icon d={SVG.seed} className="w-4 h-4 inline mr-1.5" />Seed (active, cancelled, substituted, out_of_stock)
              </button>
            )}
          </div>
        ) : (
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100">
                    ...
                    <th className="px-5 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wide">
                      Lignes<div className="text-[10px] font-normal normal-case text-gray-400 mt-0.5">Utilisations</div>
                    </th>
