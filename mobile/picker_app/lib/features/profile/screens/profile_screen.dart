      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Center(child: Text(picker?.initials ?? 'P', style: TextStyle(color: Colors.white, fontSize: 32.sp, fontWeight: FontWeight.w800))),
          ),
          SizedBox(height: 12.h),
          Text(picker?.name ?? '—', style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w800)),
          Text(picker?.displayPhone ?? '', style: TextStyle(fontSize: 14.sp, color: AppTheme.textSub)),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              _Row(icon: Icons.person_rounded,       label: 'Nom',      value: picker?.name        ?? '—'),
              Divider(height: 1, color: AppTheme.border),
              _Row(icon: Icons.phone_rounded,         label: 'Téléphone', value: picker?.displayPhone ?? '—'),
              Divider(height: 1, color: AppTheme.border),
              Row(children: [
                Container(width: 10.w, height: 10.w, decoration: const BoxDecoration(color: Color(0xFF10B981), shape: BoxShape.circle)),
                SizedBox(width: 8.w),
                Text('En service', style: TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w600, color: const Color(0xFF10B981))),
              ]),
            ]),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFFEF2F2), foregroundColor: const Color(0xFFEF4444),
