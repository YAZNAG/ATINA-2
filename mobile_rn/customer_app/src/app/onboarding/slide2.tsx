...
export default function Slide2() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require('../../../assets/images/app/onboarding2.png')}
        style={styles.image}
        resizeMode="contain"
      />

      <View style={styles.textContainer}>
        <Text style={styles.title}>Commande rapide et sécurisée</Text>
        <Text style={styles.description}>
          Suivez votre commande en temps réel et profitez d'un paiement simple et sécurisé.
        </Text>
      </View>
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push('/onboarding/slide3')}>
...
const styles = StyleSheet.create({
  ...
  description: { fontSize: 15, color: '#8A8A8A', textAlign: 'center', lineHeight: 22 ,fontFamily: 'Inter_400Regular',marginHorizontal: 25},
