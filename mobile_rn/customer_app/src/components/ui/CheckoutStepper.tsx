...
const styles = StyleSheet.create({
  ...
  stepLine: { flex: 0.5, height: 1.5, backgroundColor: '#E5E7EB', marginTop: 13 },
  ...
  stepNumber:       { fontSize: 12, fontFamily: 'Poppins_600SemiBold', color: '#9CA3AF' },
  stepNumberActive: { color: RED },
  stepLabel:        { fontSize: 10, fontFamily: 'Poppins_400Regular', color: '#9CA3AF', textAlign: 'center' },
  stepLabelActive:  { color: RED, fontFamily: 'Poppins_500Medium' },
});